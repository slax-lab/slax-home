...
I'm a PM. My teammate is a designer. Our boss told the two of us to rewrite [Slax Note](/note/) — our voice-first notes app — from scratch. Using AI.
...
Part 2 is the technical write-up — the stack, the pipeline, what broke. Coming soon on the [Slax blog](/blog/).
