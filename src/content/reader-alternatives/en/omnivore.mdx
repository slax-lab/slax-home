---
title: "Omnivore Alternative 2026 — Slax Reader, Open Source & Active"
competitor: "Omnivore"
description: "Omnivore shut down late 2024. Slax Reader is the Apache 2.0 open-source replacement still actively shipping — permanent archives, AI outlines, free tier."
...
Omnivore joined a long list — [twenty years of read-it-later shutdowns, and what survives](/blog/read-it-later-history/).
...
**Omnivore vs Readwise Reader — where should ex-Omnivore users go?**
Readwise Reader has the bigger feature set (PDF, EPUB, YouTube transcripts, TTS), but it's closed source, costs $9.99–$12.99/mo, and has no permanent free tier. If open source is why you picked Omnivore in the first place, Slax Reader keeps that promise: Apache 2.0 code, a free founding-member tier, and permanent archives. [Full Readwise Reader comparison →](/reader/alternatives/readwise-reader/)
